...
function encodeToRot13(str) {
  ...
  const decoded = 'NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm';
  const getIndex = (char) => encoded.indexOf(char);
  const traverse = (char) => (getIndex(char) > -1 ? decoded[getIndex(char)] : char);
